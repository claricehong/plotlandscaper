test_that("adjust_resolution", {
    ...
    expect_equal(plotlandscaper:::adjust_resolution(hic = IMR90_HiC_10kb,
    ...
    hic_plot <- list("chromstart" = 20000000,
                     "chromend" = 47500000)
    expect_equal(plotlandscaper:::adjust_resolution(hic = hicFile,
...
test_that("hic_limit", {
    ...
    hic_plot <- list("chromstart" = 20000000,
                     "chromend" = 47500000,
                     "resolution" = 100000)
    expect_silent(plotlandscaper:::hic_limit(hic = hicFile,
                                       hicPlot = hic_plot))
    ...
    hic_plot <- list("chromstart" = 20000000,
                     "chromend" = 47500000,
                     "resolution" = 5000)
    expect_warning(plotlandscaper:::hic_limit(hic = hicFile,
                                        hicPlot = hic_plot))
    expect_equal(suppressWarnings(plotlandscaper:::hic_limit(hic = hicFile,
                                      hicPlot = hic_plot)$resolution),
                 100000)
    
    ## Data frame NA resolution
    data("IMR90_HiC_10kb")
    expect_warning(plotlandscaper:::hic_limit(hic = IMR90_HiC_10kb,
                                        hicPlot = hic_plot))
    expect_equal(suppressWarnings(plotlandscaper:::hic_limit(hic = IMR90_HiC_10kb,
                                      hicPlot = hic_plot)$resolution),
                 NA)
})
...
test_that("set_zrange", {
    ...
    expect_equal(plotlandscaper:::set_zrange(IMR90_HiC_10kb, 
...
test_that("inherit_half", {
    ...
    expect_equal(plotlandscaper:::inherit_half(hicPlot),
                 "top")
